...
export const termsSections: TermSection[] = [
  ...
  { title: "Privacy Policy", content: "Personal data supports the site experience, account access, order handling, booking requests, class and appointment reminders, account notifications, and customer support. We collect mobile phone numbers and SMS consent only when a person knowingly opts in. Mobile information, including phone numbers and messaging consent records, will not be shared, sold, rented, or disclosed to third parties or affiliates for marketing or promotional purposes. SMS consent is not a condition of purchase. Message frequency varies. Message and data rates may apply. Reply STOP to opt out and HELP for help. We may share information with service providers only as needed to operate requested services, comply with law, protect safety, or maintain the service; those providers may not use mobile information or SMS consent for their own marketing or promotional purposes." },
