...
| Auth | Supabase Auth for `Manager1`, `Dev123`, and administrator-invited profiles; activation links are existing-account-only | Keep public signup disabled and harden production Auth settings before real users |
